...
import random
import winsound  # Windows-only untuk efek suara
...
class Ball(GameObject):
    ...
    def update(self):
        ...
        if coords[0] <= 0 or coords[2] >= width:
            self.direction[0] *= -1
            winsound.Beep(500, 50)  # Suara memantul ke sisi
...
class Brick(GameObject):
    ...
    def hit(self):
        self.hits -= 1
        if self.hits == 0:
            winsound.Beep(700, 100)  # Suara saat brick dihancurkan
            self.delete()
        else:
...
class Game(tk.Frame):
    def __init__(self, master):
        ...
        self.width = 610
        self.height = 400
        self.canvas = tk.Canvas(self, bg='#1E1F26',
                                width=self.width,
                                height=self.height)
        self.canvas.pack()
        self.pack()
    ...
    def game_loop(self):
        ...
        if num_bricks == 0:
            ...
            self.draw_text(300, 200, 'You win! Amazing job!')
